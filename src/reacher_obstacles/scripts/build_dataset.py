...
builder.create_dataset(all_trajectories, dataset_name="trajopt_dataset")
inspector = DatasetInspector(f"{project_root()}/datasets/trajopt_dataset.h5")
